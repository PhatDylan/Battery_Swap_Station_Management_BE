...
namespace BusinessObject.Migrations
{
    ...
    [Migration("20251019130032_AddNewCountsToStationInventory")]
    partial class AddNewCountsToStationInventory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BusinessObject.Entities.Battery", b =>
                {
                    ...
                    b.Property<int>("CurrentCapacityWh")
                        .HasColumnType("int")
                        .HasColumnName("current_capacity_wh");
            ...
            modelBuilder.Entity("BusinessObject.Entities.Payment", b =>
                {
                    ...
                    b.Property<string>("PaymentPayId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("BusinessObject.Entities.StationInventory", b =>
                {
                    ...
                    b.Property<int>("QualityPendingCount")
                        .HasColumnType("int")
                        .HasColumnName("quality_pending_count");
            ...
            modelBuilder.Entity("BusinessObject.Entities.SubscriptionPlan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PlanId = "plan-001",
                            Active = true,
                            CreatedAt = new DateTime(2025, 10, 19, 13, 0, 31, 826, DateTimeKind.Utc).AddTicks(9005),
                        ...
                        new
                        {
                            PlanId = "plan-002",
                            Active = true,
                            CreatedAt = new DateTime(2025, 10, 19, 13, 0, 31, 826, DateTimeKind.Utc).AddTicks(9021),
            ...
            modelBuilder.Entity("BusinessObject.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = "admin-001",
                            CreatedAt = new DateTime(2025, 10, 19, 13, 0, 31, 826, DateTimeKind.Utc).AddTicks(8175),
                            Email = "admin@evdriver.com",
                            FullName = "System Administrator",
                            Password = "$2a$11$yq/ty82RxZ2IK76td6iXIuCMAdoLBtoJuXBNdzDQluF3v/5kTBVBu",
                            Phone = "0123456789",
                            Role = 3,
                            Status = 1
                        });
            ...
            modelBuilder.Entity("BusinessObject.Entities.BatterySwap", b =>
                {
                    ...
                    b.HasOne("BusinessObject.Entities.Payment", "Payment")
                        .WithMany()
            ...
            modelBuilder.Entity("BusinessObject.Entities.Payment", b =>
                {
                    ...
                    b.HasOne("BusinessObject.Entities.Payment", null)
                        .WithMany("Payments")
