...
public class UserService : IUserService
{
    ...
    {
        var existing = _context.Users.FirstOrDefault(u => u.UserId == user.UserId && u.Status == UserStatus.Active);
    ...
    {
        var user = _context.Users.FirstOrDefault(u => u.UserId == userId && u.Status == UserStatus.Active);
